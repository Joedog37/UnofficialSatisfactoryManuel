package com.example.unofficialsatisfactorymanuel.data // Or com.example.unofficialsatisfactorymanuel.model if you moved it
...
data class BuildingData(
    ...
    val conveyorOutputs: String? = null,    // <<< UNCOMMENTED
    val productionRate: String? = null,   // <<< UNCOMMENTED
    ...
    val usageDetails: String? = null,      // <<< ADDED THIS if you are using it
